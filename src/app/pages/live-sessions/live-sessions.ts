...
export class LiveSessions {
  ...
  faqs = [
    { q: 'How long does a session run?', a: 'Soap and shampoo sessions run about 45–60 minutes. Concrete pours run 30–40 minutes, since the pour itself is quick — most of the time is the mix and mould walkthrough.' },
    { q: 'Is it free?', a: 'A soap or shampoo session is free with a batch order of 2 or more bars. Concrete DIY kit sessions include a small workshop fee, adjusted against your kit purchase.' },
